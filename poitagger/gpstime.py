...
def testTimeStuff(): 
    ...
    print("Today is GPS week 1186, day 3, seems to run ok (2011, 12, 15, 16, 43, 13.56)") 
    (w, sow, d, sod) = gpsFromUTC(2011, 12, 15, 16, 43, 13.56) 
    print("**** week: %s, sow: %s, day: %s, sod: %s" % (w, sow, d, sod)) 
    print("     and hopefully back:") 
    print("**** %s, %s, %s, %s, %s, %s\n" % UTCFromGps(w, sow)) 
 
def testJulD(): 
    print('2002, 10, 11 -> 284  ==??== ', julianDay(2011, 12, 15)) 
 
def testGpsWeek(): 
    print('2002, 10, 11 -> 1187  ==??== ', gpsWeek(2011, 12, 15)) 
 
def testDayOfWeek(): 
    print('2002, 10, 12 -> 6  ==??== ', dayOfWeek(2011, 12, 15)) 
    print('2002, 10, 6  -> 0  ==??== ', dayOfWeek(2011, 12, 15)) 
 
def testPyUtilties(): 
    ymdhms = (2011, 12, 15, 17, 9, 12.3) 
